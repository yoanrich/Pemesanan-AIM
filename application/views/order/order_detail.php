                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            ...
                                            <td style="width: 50%"> 
                                                <form method="post" action="<?=base_url().'Transaksi/sudah_membayar'?>">
                                                    <div class="form-group">
                                                        <input type="hidden" name="jual_kode" id="jual_kode" value= "<?= $b['jual_kode'];?>" class="form-control input-sm" >
                                                    </div>
                                                    <?php if($this->session->userdata('level')=="Marketing"){ echo ('<button type="submit" class="btn btn-success fa fa-check-square">  Pembayaran Diterima</button>');}else{echo "";}?>
                                                </form>
                                            </td>
                                        </tr>
                                        <tr>   
                                            ...
                                            <td style="width: 50%"> 
                                                <form method="post" action="<?=base_url().'Transaksi/sudah_membayar'?>">
                                                    <?php if($this->session->userdata('level')=="Marketing"){ echo ('<button type="submit" class="btn btn-success fa fa-check-square">  Pembayaran Ditolak</button>');}else{echo "";}?>
                                                </form>
                                            </td>
                                        </tr>
                                    </table>
